...
<body style="background-image: url('img/30772641_8.jpg');">
	...
	<div style="text-align: center;">
		...
		<form action="update" method="post">
			...
			<hr>
			 审核信息：
			<textarea name="compactRemarks" rows="10" cols="50"></textarea>
			<br> 
			<input type="button" value="审核" onclick="Coexcuss()"> 
			<input type="button" value="打回" onclick="Coex()">
			
			<input type="button" value="返回" onclick="CompactTuichu()">
